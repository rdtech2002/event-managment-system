...
<body id="page-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto my-2 my-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=venue">Venues</a>
                    </li>
  ...
  <div class="modal fade" id="confirm_modal" role='dialog'>
    ...
    <footer class=" py-5">
        ...
        <br>
        <div class="container">
            <div class="small text-center text-muted">sample copyright <?php echo $_SESSION['system']['name'] ?> | <a
                    class="text-success" href="https://www.sourcecodester.com/" target="_blank">Rahul-Tanmoy</a></div>
        </div>
    </footer>
